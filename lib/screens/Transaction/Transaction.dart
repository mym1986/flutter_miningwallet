...
import 'package:flutter_miningwallet/screens/Transaction/components/body.dart';
...
class BuildTransaction extends StatefulWidget {
  const BuildTransaction({Key? key}) : super(key: key);

  @override
  _BuildTransactionState createState() => _BuildTransactionState();
}
